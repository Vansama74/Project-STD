...
| RS485 | 768 | QH / RLS / SC_ETC / SC_MTC / SC_OL / SD / GZ / YN / ANHUI | RS485 | 青海、RLS、四川三协议、山东、贵州、云南、安徽 |
| RS232 | 768 | QH / SC_ETC / SC_MTC / SC_OL / SD / GZ / YN / ANHUI | RS232 | 青海、四川三协议、山东、贵州、云南、安徽 |
...
变更记录（2026-09-04）：新增安徽协议（ANHUI）深度 3、payload 261（数据长 1B 上限，CRC 文档注明不校验）；帧头 0x5A 串口槽唯一（IAP 5A5A5A5A 在网口槽不相交）；**队列体+cb+任务帧缓冲为静态 SRAM（+1156B，与青海/贵州/云南同——用户裁决，CQ 才是 CCMRAM 例外）**；SRAM 预算经链接期下限收紧 + RTT 缓冲 1KB 让位（doc/13 §6）；动态显示（0x86~0x89 滚动）留空 TODO、0x96/0x97 录制语音占位（语音板无段号接口），详见 doc/13。
